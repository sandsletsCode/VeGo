...
import com.example.vego.AddNewTask;
import com.example.vego.MainActivity;
import com.example.vego.Model.To_Do_Model;
import com.example.vego.R;
import com.example.vego.ToDoList;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.MyViewHolder> {
    ...
    public ToDoAdapter(DatabaseHelperForToDoL myDB,ToDoList activity){
    ...
    public void onBindViewHolder(@NonNull ToDoAdapter.MyViewHolder holder, int position) {
        final  To_Do_Model item = mList.get(position);
    ...
    public void setTasks(List<To_Do_Model> mList){
        this.mList= mList;
        notifyDataSetChanged();
    }

    public void deleteTask(int position){
        To_Do_Model item = mList.get(position);
